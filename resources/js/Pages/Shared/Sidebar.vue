<template>
  <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
    <ul class="space-y-2 font-medium">
      <li>
        <SideBarLink href="/" :isActive="$page.component === 'Home'">
          <svg
          ...
          <span class="ml-3">Dashboard</span></SideBarLink
        >
      </li>
      <li>
        <SideBarLink
          href="/users"
          :isActive="$page.component === 'Users/Index'"
        >
          <!-- <svg
      ...
      <li>
        <SideBarLink
          href="/announcements"
          :isActive="$page.component === 'Announcements/Index'"
        >
          <svg
            class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
            aria-hidden="true"
      ...
      <li>
        <SideBarLink
          href="/settings"
          :isActive="$page.component === 'Settings'"
        >
          <svg
            class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
            aria-hidden="true"
